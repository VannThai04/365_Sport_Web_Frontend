...
const filteredProducts = computed(() => {
  ...
  let result = products.filter((product) => {
    ...
    const matchType =
      ...
      (
        selectedType.value === "Popular" &&
        product.stock <= 10
      ) ||

      (
        selectedType.value === "Discount" &&
        product.discount > 0
      )
...
<div
  class="mb-6 flex h-[85px] w-full items-center rounded-2xl border border-gray-200 bg-white px-5 shadow-sm"
>
